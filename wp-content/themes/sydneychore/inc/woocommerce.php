...
function _s_woocommerce_scripts() {
	wp_enqueue_style( 'sydneychore-woocommerce-style', get_template_directory_uri() . '/woocommerce.css' );
	...
	wp_add_inline_style( 'sydneychore-woocommerce-style', $inline_font );
}
...
if ( ! function_exists( '_s_woocommerce_cart_link' ) ) {
	...
	function _s_woocommerce_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'sydneychore' ); ?>">
			<?php
			$item_count_text = sprintf(
				/* translators: number of items in the mini cart. */
				_n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'sydneychore' ),
