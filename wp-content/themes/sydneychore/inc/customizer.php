...
function _s_customize_register( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'link_color', array(
		'label'      => __( 'Choose category for slider', 'sydneychore' ),
...
function _s_customize_preview_js() {
	wp_enqueue_script( 'sydneychore-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
